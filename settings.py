...
if os.path.isfile(ENV_ROOT / "env.json"):
    ...
    CERT_AWS_BUCKET_IN_PATH = ENV_TOKENS.get('CERT_AWS_BUCKET_IN_PATH', CERT_AWS_BUCKET_IN_PATH)
    CERT_AWS_HOST = ENV_TOKENS.get('CERT_AWS_HOST', CERT_AWS_HOST)
